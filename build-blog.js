    ...
    <style>
        * {
        ...
        .gradient-bg {
            ...
            width: 100%;
            height: 100%;
            background: linear-gradient(135deg, #000 0%, #000 40%, #0d2758 100%);
            z-index: -1;
        }
...
<body>
    ...
    <style>
        #cookie-banner { position: fixed; bottom: 0; left: 0; right: 0; background: rgba(0, 0, 0, 0.97); border-top: 1px solid #F5CB3F; padding: 20px; z-index: 9999; box-shadow: 0 -4px 20px rgba(0, 0, 0, 0.3); }
        ...
        .cookie-btn-primary { background: #F5CB3F; color: #000; border: none; }
